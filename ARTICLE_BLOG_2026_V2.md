...
**Niveau** : Accessible, avec les vrais chiffres  
...
Si vous êtes arrivé ici en cherchant "rente viagère" pour vendre votre maison (bouquet + rente mensuelle), ce n'est pas le sujet.

On parle ici de **rente viagère financière** : transformer un capital (PER, assurance-vie, épargne) en revenus mensuels versés jusqu'à votre décès.

Deux concepts totalement différents qui portent le même nom. Si c'est bien ça qui vous intéresse, continuons.
...
Plus vous attendez, plus la rente est élevée. Mais attention au piège.

**Exemple pour 200 000€** :

| Âge | Rente/mois | Seuil | Espérance | Écart |
|-----|------------|-------|-----------|-------|
| 65 ans | 1 020€ | 16,3 ans | 20 ans | +3,7 ans ✅ |
| 70 ans | 1 360€ | 12,3 ans | 16 ans | +3,7 ans ✅ |
| 75 ans | 1 840€ | 9,1 ans | 12 ans | +2,9 ans ✅ |

**Observation** : Plus vous attendez, plus le seuil se rapproche de l'espérance. Mais l'écart reste toujours positif pour l'assureur.

**Le sweet spot** : 70-75 ans. Avant 70 ans, vous perdez beaucoup de rente potentielle. Après 75 ans, votre espérance diminue vite.

### 2. La réversion (le piège à 30 000€)

La réversion garantit que votre conjoint continue de toucher 60%, 80% ou 100% de la rente après votre décès.

**Coût réel** (homme 65 ans, femme 63 ans, 200 000€) :

| Type | Rente initiale | Si homme meurt | Coût sur 20 ans |
|------|---------------|----------------|-----------------|
| Sans réversion | 1 020€/mois | 0€ pour elle | 0€ |
| Réversion 60% | 770€/mois | 462€ pour elle | -60 000€ |

Vous perdez **250€/mois** (25% de la rente). Sur 20 ans : **60 000€ de manque à gagner**.

**Le piège** : La réversion est **unidirectionnelle**. Si votre conjoint meurt AVANT vous, vous ne touchez rien en plus. Vous avez juste accepté une rente réduite pour rien.
...
Avant, les contrats garantissaient un taux technique de 1,5-2%. L'assureur vous donnait une rente initiale plus élevée, moins revalorisée ensuite.

**Exemple** (200 000€, 65 ans) :
- Taux 0% : 1 020€/mois, revalorisé selon inflation réelle
- Taux 2% : 1 230€/mois (+20%), revalorisation plus faible

Depuis 2016, la plupart des nouveaux contrats sont à taux 0%. Pourquoi ? Parce qu'avec des taux obligataires à 1-2%, les assureurs ne peuvent plus garantir 2%.

**Règle** : Méfiez-vous des vieux contrats à taux technique élevé. Vérifiez la revalorisation historique.
...
**Alternative** : Gardez le capital investi (ETF, immobilier) qui suit naturellement l'inflation.

---

## Le calculateur qui dit la vérité

C'est pour ça que j'ai créé **CalcPatrimoine** : un simulateur qui vous montre les VRAIS chiffres.

**Ce qu'il affiche (et que votre conseiller ne vous montre pas)** :
- Seuil de rentabilité exact (en années décimales, ex: 15,8 ans)
- Graphique projection 30 ans (capital vs rente cumulée)
- Espérance de vie INSEE 2022 (pour comparer)
- Impact réel de la réversion (en €/mois perdu)

**3 modes** :
1. Capital → Rente mensuelle
2. Rente souhaitée → Capital nécessaire
...
### 1. Souscrire trop tôt (erreur à 100 000€)

**Marc, 60 ans** : Convertit 200 000€ en rente.
- Rente à 60 ans : 780€/mois
- S'il attend 70 ans : 1 360€/mois (+74%)

**Coût** : 580€/mois de perdu, soit 6 960€/an. Sur 20 ans : **139 200€ de manque à gagner**.

"Oui mais pendant 10 ans je ne touche rien !"

Faux. Pendant 10 ans, Marc vit sur le capital : retraits programmés 800€/mois = 96 000€. Il lui reste 104 000€ à 70 ans, convertis en 705€/mois.

**Bilan** : Marc touche moins (705€ vs 780€), mais seulement pendant 10 ans. Après, terminé. Alors qu'en attendant 70 ans, il toucherait 1 360€ pendant 15-20 ans.

### 2. Réversion non négociée (erreur à 60 000€)

**Sophie (65 ans) et Paul (64 ans)** : Sophie convertit 200 000€ avec réversion 60%.

- Sans réversion : 1 020€/mois
- Avec réversion : 770€/mois

Sophie perd 250€/mois. Sur 20 ans : **60 000€**.

Problème : Paul a sa propre retraite (1 500€/mois) et une assurance-vie (100 000€). La protection était inutile.

### 3. Frais cachés (erreur à 5 000€)

Certains contrats prélèvent :
- Frais de conversion : 1-3% (2 000-6 000€ sur 200 000€)
- Frais de gestion annuels : 0,5-1% (1 000-2 000€/an)

Sur 200 000€, ça représente 2 000-6 000€ immédiatement perdus + 1 000-2 000€/an en gestion.

**Règle** : Comparez 3-4 assureurs. Négociez. Les frais varient du simple au triple.

### 4. Clause dépendance oubliée

Certains contrats offrent une majoration de 30-50% si vous devenez dépendant (perte d'autonomie).

Coût : 3-5% de rente en moins au départ.

**Exemple** (200 000€, 70 ans) :
- Sans option : 1 360€/mois
- Avec option : 1 290€/mois (-70€)

Si vous finissez en EHPAD à 90 ans, la rente passe à 1 935€/mois. Ça couvre une grosse partie des frais.

**Règle** : Si vous avez 70+ ans et aucune assurance dépendance, cette option peut valoir le coup.

---

## Questions que tout le monde se pose (les vraies réponses)

### Puis-je récupérer mon capital si je change d'avis ?

**Non**. Irréversible. Une fois signé, c'est définitif.

Seule exception rarissime : clause "annuités garanties". Si vous décédez dans les 10 premières années, vos héritiers touchent le solde. Mais ça réduit la rente de 10-15%.

### La rente est-elle revalorisée chaque année ?

**Oui**, c'est obligatoire (Code des assurances, article A331-5).

La revalorisation suit généralement l'IPC (inflation), mais dépend aussi des résultats financiers de l'assureur.

**Piège** : Certains assureurs revalorisent mal (0,5%/an alors que l'inflation est à 2-3%). Vérifiez l'historique.
...
Au-delà, vous prenez le risque.

**Règle** : Diversifiez. 100 000€ chez Assureur A, 100 000€ chez Assureur B. Deux rentes de 510€ valent mieux qu'une seule de 1 020€.
...
À 70 ans, la rente assurance-vie est plus avantageuse fiscalement.

Mais le PER permet de déduire les versements des impôts pendant la phase d'épargne (jusqu'à 10% du revenu).

**Règle** : PER si TMI élevée pendant vie active. Assurance-vie si TMI faible à la retraite.

---

## Ce qu'il faut retenir (les 10 points essentiels)

1. **La rente viagère est un PARI sur votre longévité**, pas un placement. Vous gagnez si vous vivez plus vieux que la moyenne.

2. **Le seuil de rentabilité est APRÈS l'espérance de vie**. C'est normal : l'assureur prend une marge. Statistiquement, il gagne.

3. **Plus vous attendez, plus la rente est élevée**. Sweet spot : 70-75 ans. Avant, vous perdez trop de rente.

4. **La réversion coûte 20-30% de rente** et est unidirectionnelle. Calculez le besoin réel de votre conjoint avant.

5. **Irréversible**. Une fois signé, impossible de récupérer le capital. Réfléchissez TRÈS bien.

6. **Seulement si vous vivez vieux**. Excellente santé, longévité familiale = avantage. Santé fragile = fuyez.

7. **Vérifiez les frais** (conversion + gestion). Ils varient du simple au triple selon les assureurs.

8. **Comparez avec assurance-vie et PER** selon votre situation (héritiers, flexibilité, santé).

9. **Utilisez CalcPatrimoine** pour voir les VRAIS chiffres : seuil exact, graphique projection, impact réversion.

10. **Ne faites pas confiance aveuglément** à votre conseiller. Son intérêt (commission) n'est pas toujours aligné avec le vôtre.
...
**Simulateur** :
- [CalcPatrimoine](https://calcpatrimoine.fr) - Gratuit, transparent, open-source
...
- [Service-Public.fr](https://www.service-public.fr/particuliers/vosdroits/F3173) - Fiscalité rentes viagères
- Code des assurances, articles A331-1 à A331-11

**Code source** :
- [GitHub CalcPatrimoine](https://github.com/calcpatrimoine) - Formules, tables JSON
