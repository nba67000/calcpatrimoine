...
export default function InverseCalculator() {
 ...
 <strong>Table de mortalité unisexe (réglementation 2012)</strong><br />
 ...
 <div className="bg-primary-50 rounded-lg border-l-4 border-primary-200 p-6">
 ...
 showReversion ? 'bg-primary-500' : 'bg-neutral-300'
 }`}
>
 <span
