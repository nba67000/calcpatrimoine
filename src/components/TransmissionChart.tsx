...
const COULEURS_LIEN: Record<string, string> = {
 conjoint: 'from-primary-500 to-primary-600',
 enfant: 'from-primary-500 to-primary-600',
 frere_soeur: 'from-primary-600 to-primary-600',
 neveu_niece: 'from-primary-500 to-primary-700',
 autre: 'from-primary-500 to-primary-600'
}

const COULEURS_LIEN_BG: Record<string, string> = {
 conjoint: 'bg-primary-50 border-primary-200',
 enfant: 'bg-primary-50 border-primary-200',
 frere_soeur: 'bg-primary-50 border-primary-200',
 neveu_niece: 'bg-primary-50 border-primary-200',
 autre: 'bg-primary-50 border-primary-200'
}
...
export default function TransmissionChart({ results }: TransmissionChartProps) {
 ...
 {/* Part nette (verte) */}
 <div
 className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary-400 to-primary-500 flex items-center justify-start pl-4 transition-all duration-1500 ease-out"
...
>
 ...
 {/* Part impôts (rouge) */}
 <div
 className="absolute inset-y-0 right-0 bg-gradient-to-r from-primary-500 to-primary-500 flex items-center justify-end pr-4 transition-all duration-1500 ease-out"
...
>
 ...
 {/* Part impôts */}
 <div
 className="absolute inset-y-0 right-0 bg-gradient-to-r from-primary-300 to-primary-500 transition-all duration-1000 ease-out"
 style={{ 
 ...
 <div className="font-bold text-primary-700 tabular-nums">
 ...
 <div className="bg-gradient-to-br from-primary-50 to-primary-100 border-2 border-primary-300 rounded-xl p-6">
