    ...
    <div ref={chartRef} className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={`w-4 h-4 rounded-full ${
              optionMoinsImposee === 'PFU' ? 'bg-success-500' : 'bg-neutral-400'
            }`} />
        ...
        <div className="text-sm text-neutral-600 space-y-1">
          ...
          <div className="flex justify-between font-bold text-neutral-900 pt-2 border-t">
            <span>Net perçu :</span>
            <span className="text-success-600">{optionPFU.netPercu.toLocaleString('fr-FR')}€</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={`w-4 h-4 rounded-full ${
              optionMoinsImposee === 'IR' ? 'bg-success-500' : 'bg-neutral-400'
            }`} />
            <span className="font-bold text-lg text-neutral-900">
              {optionIR.nom}
            </span>
        ...
        <div className="text-sm text-neutral-600 space-y-1">
          ...
          <div className="flex justify-between font-bold text-neutral-900 pt-2 border-t">
            <span>Net perçu :</span>
            <span className="text-success-600">{optionIR.netPercu.toLocaleString('fr-FR')}€</span>
          </div>
        </div>
      </div>
