    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <article className="max-w-4xl mx-auto px-4 py-16">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">🔍 Le constat : un marché opaque</h2>
          
          <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
            <p className="text-gray-700 mb-4">
              En 2026, je cherchais à simuler une rente viagère pour un projet personnel. 
              J&apos;ai testé les 9 calculateurs disponibles en ligne. Le résultat ? <strong>Catastrophique</strong>.
            </p>
            ...
            <div className="space-y-3 text-sm text-gray-700">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>MoneyVox</strong> : Avoue lui-même que ses calculs sont "trop optimistes" (donc faux)
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-red-500 font-bold">✗</span>
                <div>
                  <strong>HSBC</strong> : Nécessite un login bancaire juste pour faire une simulation
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-red-500 font-bold">✗</span>
                <div>
                  <strong>80% des sites</strong> : Design années 2000, bouton "Calculer", mobile cassé
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-red-500 font-bold">✗</span>
                <div>
                  <strong>100% des sites</strong> : Aucun ne propose de calculateur inverse ou mode couple
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6">
            <p className="text-sm text-yellow-800">
              <strong>💡 L&apos;ironie</strong> : Je suis développeur COBOL chez <strong>Império Assurances</strong>, 
              une compagnie d&apos;assurance-vie. Je travaille tous les jours sur des systèmes qui calculent des rentes. 
              Et même moi, impossible de trouver un outil fiable pour simuler la mienne.
            </p>
          </div>
        </section>
