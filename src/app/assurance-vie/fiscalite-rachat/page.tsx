    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <Link
          ...
          className="block bg-purple-50 border-2 border-purple-200 rounded-xl p-8 hover:border-purple-400 hover:shadow-lg transition-all group mb-6"
        >
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <Link
          ...
          className="block bg-success-50 border-2 border-success-200 rounded-xl p-8 hover:border-success-400 hover:shadow-lg transition-all group"
        >
          <div className="flex items-start gap-4">
            <div className="text-4xl">❓</div>
            <div className="flex-1">
              <h3 className="text-2xl font-bold text-neutral-900 mb-3 group-hover:text-success-600 transition-colors">
              ...
              <div className="flex items-center gap-2 text-success-600 font-medium group-hover:gap-3 transition-all">
