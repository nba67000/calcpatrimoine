...
export default function ArticleRenteViagere() {
 ...
 <div className="bg-primary-50 border-2 border-primary-400 rounded-xl p-8 my-12">
 ...
 {/* Box avertissement */}
 <div className="bg-primary-50 border-l-4 border-primary-400 p-8 rounded-r-lg my-12">
 <h3 className="text-xl font-bold text-primary-900 mb-4">
 Clarification : nous parlons de rente viagère financière
 </h3>
 ...
 255 000€ / (1 340€ × 12 mois) = <strong className="text-primary-600 text-xl">15,8 années</strong>
 </p>
 ...
 <p className="mt-8 text-primary-700 font-bold">
 ...
 <div className="bg-primary-50 border-l-4 border-primary-600 p-8 rounded-r-lg my-12">
 <p className="font-bold text-primary-900 text-lg mb-3">
 Règle d'or :
 </p>
...
>
 ...
 <div className="bg-primary-50 border-l-4 border-primary-400 p-6 rounded-r-lg my-8">
 ...
 <li>• À 70 ans : environ 1 360€ par mois <span className="text-primary-600 font-bold">(soit +74%)</span></li>
 </ul>
 </div>
