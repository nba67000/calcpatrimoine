...
export default function ArticleAssuranceViePage() {
 ...
 <div className="bg-primary-50 border-2 border-primary-400 rounded-xl p-6 mb-12">
 <div className="flex items-start gap-4">
 <div className="text-3xl"></div>
 <div>
 <h3 className="font-bold text-primary-900 mb-3">Outil de comparaison uniquement</h3>
...
>
 ...
 <p className="font-bold text-primary-900 mb-2">Idée reçue</p>
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-6 mb-6">
 <p className="font-bold text-primary-900 mb-2">Réalité</p>
 <p className="text-primary-800">
...
>
 ...
 <p className="font-bold text-primary-900 mb-3">Sans abattement (contrat &lt; 8 ans)</p>
 ...
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-6">
 <p className="font-bold text-primary-900 mb-3">Avec abattement (contrat ≥ 8 ans, seul)</p>
 <div className="font-mono text-sm space-y-1">
 <p>Plus-value dans rachat : 15 000€</p>
 ...
 <p className="font-bold text-primary-900 mb-2">Économie réalisée</p>
 <p className="text-primary-800">
 ...
 <p className="font-bold text-primary-900 border-t border-primary-300 pt-3">
 ...
 <td className="border border-neutral-300 p-3 bg-primary-50">PFU coûte +74%</td>
 </tr>
 <tr>
 <td className="border border-neutral-300 p-3">11%</td>
 <td className="border border-neutral-300 p-3">28,2%</td>
 <td className="border border-neutral-300 p-3">30%</td>
 <td className="border border-neutral-300 p-3 bg-primary-50">PFU coûte +6%</td>
 </tr>
 <tr>
 <td className="border border-neutral-300 p-3">30%</td>
 <td className="border border-neutral-300 p-3">47,2%</td>
 <td className="border border-neutral-300 p-3">30%</td>
 <td className="border border-neutral-300 p-3 bg-primary-50">IR coûte +57%</td>
 </tr>
 <tr>
 <td className="border border-neutral-300 p-3">41%</td>
 <td className="border border-neutral-300 p-3">58,2%</td>
 <td className="border border-neutral-300 p-3">30%</td>
 <td className="border border-neutral-300 p-3 bg-primary-50">IR coûte +94%</td>
 </tr>
 <tr>
 <td className="border border-neutral-300 p-3">45%</td>
 <td className="border border-neutral-300 p-3">62,2%</td>
 <td className="border border-neutral-300 p-3">30%</td>
 <td className="border border-neutral-300 p-3 bg-primary-50">IR coûte +107%</td>
 </tr>
 </tbody>
 </table>
 </div>
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-6 my-6">
 <p className="font-bold text-primary-900 mb-3">Verdict simple</p>
...
>
 ...
 <p className="font-bold text-primary-900 mb-3">Le taux préférentiel</p>
 ...
 <p className="font-bold text-primary-700 pt-2">= Total : 24,7% (au lieu de 30%)</p>
 </div>
...
>
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-6 mb-6">
 <p className="font-bold text-primary-900 mb-2">Ce qui est taxé</p>
 <p className="text-primary-800">
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-6 my-6">
 <p className="font-bold text-primary-900 mb-3">Important</p>
 <p className="text-primary-800">
...
>
 ...
 <p className="font-bold text-primary-900 mb-2">Retrait immédiat</p>
 ...
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
 <p className="font-bold text-primary-900 mb-2">Attente de 2 mois</p>
 <div className="text-sm space-y-1">
 <p>Plus-value : 15 000€</p>
 <p>Abattement : 4 600€</p>
 ...
 <p className="font-bold text-primary-900 mb-2">Problème :</p>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
 <p className="font-bold text-primary-900 mb-2">Rachat unique (décembre N)</p>
 <div className="text-sm space-y-1">
 ...
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
 <p className="font-bold text-primary-900 mb-2">Rachat fractionné (déc N + janv N+1)</p>
 <div className="text-sm space-y-1">
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
 <p className="font-bold text-primary-900 mb-2">PFU par défaut</p>
 <div className="text-sm space-y-1">
 ...
 <div className="bg-primary-50 border border-primary-200 rounded-lg p-4">
 <p className="font-bold text-primary-900 mb-2">Option IR + PS</p>
 <div className="text-sm space-y-1">
 <p>Plus-value taxable : 10 000€</p>
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-4 mb-4">
 <p className="font-bold text-primary-900 mb-2">Erreur :</p>
 <p className="text-sm text-primary-800">
 ...
 <p className="font-bold text-primary-900 mb-2">Sur 20 000€ de plus-value :</p>
 <div className="text-sm space-y-1 text-primary-800">
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-4 mb-4">
 <p className="font-bold text-primary-900 mb-2">Erreur de calcul :</p>
 <p className="text-sm text-primary-800">
 ...
 <div className="bg-primary-50 border-l-4 border-primary-500 p-4">
 <p className="font-bold text-primary-900 mb-2">Réalité (règle proportionnelle) :</p>
 <div className="text-sm space-y-1 text-primary-800">
 ...
 {/* Cas 1 : Retraité */}
 <div className="mb-10">
 <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-t-lg p-4">
 <h3 className="text-xl font-bold">Cas 1 : Retraité modeste (TMI 0%)</h3>
 </div>
 <div className="bg-primary-50 border-2 border-primary-200 rounded-b-lg p-6">
 <p className="mb-4">
 ...
 <div className="space-y-4 text-sm">
 <div>
 <p className="font-bold text-primary-900">Étape 1 : Règle proportionnelle</p>
 <p>Plus-value dans rachat : 50 000 × (30 000 ÷ 100 000) = 15 000€</p>
 </div>
 
 <div>
 <p className="font-bold text-primary-900">Étape 2 : Abattement 8 ans</p>
 <p>Plus-value taxable : 15 000 - 4 600 = 10 400€</p>
 </div>

 <div>
 <p className="font-bold text-primary-900">Étape 3 : Comparaison fiscale</p>
 <div className="grid grid-cols-2 gap-4 mt-2">
 <div className="bg-primary-50 p-3 rounded">
 <p className="font-bold text-primary-900">PFU (30%)</p>
 <p>10 400 × 30% = <strong>3 120€</strong></p>
 </div>
 <div className="bg-primary-50 p-3 rounded">
 <p className="font-bold text-primary-700">IR + PS</p>
 ...
 <div className="bg-primary-100 border-l-4 border-primary-600 p-4">
 <p className="font-bold text-primary-700 mb-2">Conclusion</p>
 ...
 {/* Cas 2 : Cadre */}
 <div className="mb-10">
 <div className="bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-t-lg p-4">
 ...
 <div className="grid grid-cols-2 gap-4 mt-2">
 <div className="bg-primary-50 p-3 rounded">
 <p className="font-bold text-primary-700">PFU (30%)</p>
 <p>4 400 × 30% = <strong>1 320€</strong></p>
 </div>
 <div className="bg-primary-50 p-3 rounded">
 <p className="font-bold text-primary-900">IR + PS</p>
 ...
 <div className="bg-primary-50 border-2 border-primary-300 rounded-b-lg p-6">
 <p className="mb-4">
 ...
 <div>
 <p className="font-bold text-primary-900">Étape 2 : Abattement couple (9 200€)</p>
 <p>Plus-value taxable : 18 000 - 9 200 = 8 800€</p>
 </div>

 <div>
 <p className="font-bold text-primary-900">Étape 3 : Taux réduit pré-2017</p>
 <p className="text-xs">Tous versements avant 2017 → taux 24,7% au lieu de 30%</p>
 </div>

 <div>
 <p className="font-bold text-primary-900">Étape 4 : Comparaison fiscale</p>
 <div className="grid grid-cols-2 gap-4 mt-2">
 <div className="bg-primary-50 p-3 rounded">
 <p className="font-bold text-primary-700">PFU (24,7%)</p>
 ...
 <p className="font-bold text-primary-900 mb-2">⚙️ Notre calculateur applique tout ça</p>
 <p className="text-primary-800">
